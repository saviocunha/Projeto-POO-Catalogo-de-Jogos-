...
def escolher_usuario(usuarios):
    """Permite selecionar um usuário existente da lista."""
...
def menu_jogos(usuario):
    """Exibe o menu de opções para o catálogo de jogos do usuário."""
...
def cadastrar_jogo(usuario):
    """Permite ao usuário adicionar um novo jogo ao seu catálogo."""
    print("\nCadastro de Jogo")
...
def listar_jogos(usuario):
    """Lista todos os jogos cadastrados no catálogo do usuário."""
...
def atualizar_progresso(usuario):
    """Permite adicionar horas jogadas a um jogo específico."""
...
def finalizar_jogo(usuario):
    """Marca um jogo como finalizado e atribui uma nota."""
    listar_jogos(usuario)
...
def executar_cli(usuario):
    """Loop principal do menu de jogos para um usuário logado."""
    while True:
...
def executar_sistema(usuarios):
    """Loop principal do sistema, gerenciando login e cadastro de usuários."""
    while True:
        opcao = menu_usuarios()
